...
#include "artery/scenarios/lte-test_bicicleta/EmergencyServiceRSU.h"
#include "artery/scenarios/lte-test_bicicleta/den/Test.h"
...
Define_Module(artery::EmergencyServiceRSU::BycicleAccident)

void BycicleAccident::check()
{
    if (mPendingRequest) {
...
void BycicleAccident::indicate(const artery::DenmObject& denm)
{
...
void BycicleAccident::transmitMessage(RequestResponseIndication_t ind)
{
...
void BycicleAccident::handleStoryboardTrigger(const StoryboardSignal& signal)
{
...
vanetza::asn1::Denm BycicleAccident::createMessage(RequestResponseIndication_t ind)
{
...
vanetza::btp::DataRequestB BycicleAccident::createRequest()
{
