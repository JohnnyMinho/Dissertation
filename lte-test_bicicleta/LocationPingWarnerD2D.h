#ifndef LOCATIONPINGWARNERD2D_H_
#define LOCATIONPINGWARNERD2D_H_
...
class LocationPingWarnerD2D : public omnetpp::cSimpleModule, public omnetpp::cListener
{
public:
    ~LocationPingWarnerD2D();
