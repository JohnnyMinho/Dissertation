#ifndef EMERGENCY_SERVICERSU_H_
#define EMERGENCY_SERVICERSU_H_
...
class Emergency_ServiceRSU : public artery::ItsG5BaseService
{
public:
    ~Emergency_ServiceRSU();
